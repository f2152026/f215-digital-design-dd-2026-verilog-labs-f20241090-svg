...
module dut(
  ...
  // ---- Option 4: flat with gate primitives with delays (unblocked) 64-bit carry-lookahead adder ----
  // cla64_flat_gate_primitives_delays U_IMPL (.a(a), .b(b), .cin(cin), .sum(sum), .cout(cout));
